...
public class AircraftNotificationService {
    ...
    public void sendAircraftUpdate(FlightTrackingRequest tracking) {
        if (tracking.getFlightId() == null) return;
        ...
        if (tracking.getLatitude() == null || tracking.getLongitude() == null) return;
    ...
    public void sendBatchUpdate(String areaKey) {
        ...
        try {
            ...
            for (Object flightIdObj : activeFlights) {
                ...
                FlightTrackingRequest flightData = trackingCacheService.getFlightTracking(flightId);
