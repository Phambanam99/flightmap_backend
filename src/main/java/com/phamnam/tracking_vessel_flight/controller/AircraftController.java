...
import com.phamnam.tracking_vessel_flight.service.AircraftService;
...
public class AircraftController {
    ...
    @GetMapping
    public ResponseEntity<MyApiResponse<List<Aircraft>>> getAllAircraft() {
    ...
    public ResponseEntity<MyApiResponse<PageResponse<Aircraft>>> getAllAircraftPaginated(
        ...
        Page<Aircraft> aircraftPage = aircraftService.getAllPaginated(pageable);
    ...
    @GetMapping("/{id}")
    public ResponseEntity<MyApiResponse<Aircraft>> getAircraftById(@PathVariable Long id) {
    ...
    @PostMapping
    public ResponseEntity<MyApiResponse<Aircraft>> createAircraft(
            @Valid @RequestBody AircraftRequest aircraftRequest,
            @RequestParam(required = false) Long userId) {
        Aircraft savedAircraft = aircraftService.save(aircraftRequest, userId);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<MyApiResponse<Aircraft>> updateAircraft(
            @PathVariable Long id,
            @Valid @RequestBody AircraftRequest aircraftRequest,
            @RequestParam(required = false) Long userId) {
        Aircraft updatedAircraft = aircraftService.updateAircraft(id, aircraftRequest, userId);
    ...
    @GetMapping("/hexident/{hexident}")
    public ResponseEntity<MyApiResponse<Aircraft>> getAircraftByHexident(@PathVariable String hexident) {
