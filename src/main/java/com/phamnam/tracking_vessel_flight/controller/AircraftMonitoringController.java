...
import com.phamnam.tracking_vessel_flight.service.rest.AircraftMonitoringService;
...
public class AircraftMonitoringController {
        ...
        @GetMapping
        public ResponseEntity<MyApiResponse<List<AircraftMonitoringResponse>>> getAll() {
        ...
        public ResponseEntity<MyApiResponse<PageResponse<AircraftMonitoringResponse>>> getAllPaginated(
                ...
                Page<AircraftMonitoringResponse> monitoringPage = aircraftMonitoringService.getAllPaginated(pageable);

                return ResponseEntity.ok(MyApiResponse.success(
                                PageResponse.fromPage(monitoringPage),
                                "Aircraft monitoring retrieved successfully"));
        }
        ...
        @GetMapping("/{id}")
        public ResponseEntity<MyApiResponse<AircraftMonitoringResponse>> getById(@PathVariable Long id) {
        ...
        public ResponseEntity<MyApiResponse<List<AircraftMonitoringResponse>>> getByUserId(@PathVariable Long userId) {
                List<AircraftMonitoringResponse> monitoringEntries = aircraftMonitoringService.getByUserId(userId);
                return ResponseEntity.ok(MyApiResponse.success(monitoringEntries,
                                "User aircraft monitoring retrieved successfully"));
        }
        ...
        public ResponseEntity<MyApiResponse<List<AircraftMonitoringResponse>>> getByAircraftId(
                        @PathVariable Long aircraftId) {
                List<AircraftMonitoringResponse> monitoringEntries = aircraftMonitoringService
                                .getByAircraftId(aircraftId);
                return ResponseEntity.ok(
                                MyApiResponse.success(monitoringEntries, "Aircraft monitoring retrieved successfully"));
        }
        ...
        @PostMapping
        public ResponseEntity<MyApiResponse<AircraftMonitoringResponse>> save(
                        @Valid @RequestBody AircraftMonitoringRequest request) {
                AircraftMonitoringResponse savedMonitoring = aircraftMonitoringService.save(request);
                return new ResponseEntity<>(
                                MyApiResponse.success(savedMonitoring, "Aircraft monitoring created successfully"),
                                HttpStatus.CREATED);
        }
        ...
        public ResponseEntity<MyApiResponse<Void>> deleteAircraftMonitoringByUserAndAircraft(
                ...
                return ResponseEntity
                                .ok(MyApiResponse.success(null, "Aircraft monitoring entries deleted successfully"));
        }
}
