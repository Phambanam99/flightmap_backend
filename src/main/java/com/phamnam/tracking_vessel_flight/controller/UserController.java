...
import com.phamnam.tracking_vessel_flight.service.UserService;
...
public class UserController {
    ...
    @GetMapping
    public ResponseEntity<MyApiResponse<List<User>>> getAllUsers() {
    ...
    public ResponseEntity<MyApiResponse<PageResponse<User>>> getAllUsersPaginated(
    ...
    @GetMapping("/{id}")
    public ResponseEntity<MyApiResponse<User>> getUserById(@PathVariable Long id) {
    ...
    @PostMapping
    public ResponseEntity<MyApiResponse<User>> createUser(@Valid @RequestBody UserRequest userRequest) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<MyApiResponse<User>> updateUser(
